                        {item.mriList.length > 0 && (
                          ...
                          <View style={{ backgroundColor: '#fff', width: '100%', borderTop: '1px solid #f0f0f0' }}>
                            {/* 第一行：表头 */}
                            <View style={{ width: '100%', display: 'flex', flexDirection: 'row', borderBottom: '1px solid #f0f0f0', height: 17 }}>
                            ...
                            {item.mriList.map((device, index) => (
                              <View key={index} style={{ width: '100%', display: 'flex', flexDirection: 'row', borderBottom: '1px solid #f0f0f0', height: 17 }}>
                                {/* 设备名称 */}
                                <View style={{ width: '32%', justifyContent: 'center'}}>
                                  <Text
                                    style={{
